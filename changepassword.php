...
<!-- SIDEBAR MENU -->
    <div class="profile-usermenu">
        <ul class="nav">
            ...
            <li class="active"><a href="<?php echo 'changepassword.php'; ?>"><i class="glyphicon glyphicon-user"></i> Change Password </a></li>
            <li><a href="<?php echo 'detailedtask.php'; ?>"><i class="glyphicon glyphicon-ok"></i> Tasks </a></li>
